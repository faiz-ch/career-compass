...
if (error) {
  return (
    <div className="cyber-card p-6 text-center">
      <h2 className="text-xl font-bold text-white mb-4">AI Interview Results</h2>
      <p className="text-dark-300 text-lg mb-6">
        Please take AI interview first
      </p>
      <button
        onClick={() => window.location.href = '/ai-interview'}
        className="cyber-button px-6 py-3 text-base font-medium"
      >
        Start AI Interview
      </button>
    </div>
